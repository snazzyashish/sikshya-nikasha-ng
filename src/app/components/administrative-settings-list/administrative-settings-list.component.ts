...
declare var $ : any;
@Component({
  selector: 'app-administrative-settings-list',
  templateUrl: './administrative-settings-list.component.html',
  styleUrls: ['./administrative-settings-list.component.css']
})
export class AdministrativeSettingsListComponent implements AfterViewInit {
  ...
  onAddClick(){
    ...
    this.router.navigate(['admin-setting/create'])
    // this.onNewModeOpen();
  }

  onEditModeOpen(id:any){
    var me = this;
    this.router.navigate(['admin-setting/update/'+id])
  }
  onViewModeOpen(id:any){
    var me = this;
    this.router.navigate(['admin-setting/view/'+id])
  }
